...
export default function SingleTour() {
  ...
  // console.log("JSON.parse(tourData.description)JSON.parse(tourData.description)", JSON.parse(tourData?.description))
  console.log("tourDatatourData", tourData?.description && JSON.parse(tourData?.description))
  return (
    <>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.detailsGrid}>
          ...
          <div className={styles.detailCard}>
            ...
            <p className={styles.detailText}>{tourData?.description && locale && JSON.parse(tourData?.description)?.[locale as any]}</p>
          </div>
